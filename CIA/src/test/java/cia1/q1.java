...
public class q1
{
    public static void main( String[] args ) throws InterruptedException
    {
        ...
        driver.get("https://www.amazon.in/realme-Segment-Fastest-Charging-High-res/dp/B0BZ466BWW/ref=sr_1_1_sspa?crid=EAGODZ3WF3I8&keywords=realme&qid=1683191501&sprefix=realme%2Caps%2C323&sr=8-1-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&th=1");
        driver.manage().window().maximize();
        String title = driver.getTitle();
        String etitle = "realme narzo N55 (Prime Blue, 6GB+128GB) 33W Segment Fastest Charging | Super High-res 64MP Primary AI Cameras";
        ...
        driver.get("https://www.amazon.in/cart/smart-wagon?newItems=C81ae878d-21b5-40e8-a6fb-eabac0cd4b85,1&ref_=sw_refresh");
        driver.findElement(By.xpath("//*[@id=\"add-to-cart-button\"]")).click();
        Thread.sleep(2000);
        driver.get("https://www.amazon.in/gp/cart/view.html/ref=dp_atch_dss_cart?");
        Thread.sleep(5000);
